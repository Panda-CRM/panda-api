...
var (
	...
	ErrLenghtName = errors.New("Nome deve ter mais que 2 caracteres")
...
type Person struct {
	...
	Type				string		`json:"type" sql:"type:varchar(1); not null"`
	Name				string 		`json:"name" sql:"type:varchar(100); not null"`
	CityName 			string		`json:"city_name" sql:"type:varchar(50)"`
	CompanyName 		string		`json:"company_name" sql:"type:varchar(100)"`
	Address 			string 		`json:"address" sql:"type:varchar(50)"`
	Number 				string	 	`json:"number" sql:"type:varchar(7)"`
	Complement 			string	 	`json:"complement" sql:"type:varchar(50)"`
	District 			string	 	`json:"district" sql:"type:varchar(50)"`
	Zip 				string	 	`json:"zip" sql:"type:varchar(9)"`
	BirthDate 			*time.Time  `json:"birth_date" sql:"type:timestamp without time zone; default:null"`
	Cpf 				string	 	`json:"cpf" sql:"type:varchar(14)"`
	Rg 					string	 	`json:"rg" sql:"type:varchar(20)"`
	Gender 				string	 	`json:"gender" sql:"type:varchar(1)"`
	BusinessPhone 		string	 	`json:"business_phone" sql:"type:varchar(20)"`
	HomePhone 			string	 	`json:"home_phone" sql:"type:varchar(20)"`
	MobilePhone 		string	 	`json:"mobile_phone" sql:"type:varchar(20)"`
	Cnpj 				string	 	`json:"cnpj" sql:"type:varchar(18)"`
	StateInscription 	string 		`json:"state_inscription" sql:"type:varchar(20)"`
	Phone 				string	 	`json:"phone" sql:"type:varchar(20)"`
	Fax 				string	 	`json:"fax" sql:"type:varchar(20)"`
	Email 				string	 	`json:"email" sql:"type:varchar(255)"`
	Website 			string	 	`json:"website" sql:"type:varchar(50)"`
